...
export const fetchAllGameInfo = async (gameName) => {
  ...
  const responseInfo = await fetch(`/api/game/${guid}/?api_key=${GIANT_BOMB_API_KEY}&format=json&field_list=original_release_date,company,companies,genres,platforms,name,deck,characters,locations,developers,images`)
